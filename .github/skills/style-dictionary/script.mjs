 ...
 *
 * Usage:
 *   node script.mjs               -- tokens → _sass/design/_variables-generated.scss (via Style Dictionary)
 *   node script.mjs --reverse     -- _sass/design/ → tokens-extracted.json
...
const OUTPUT_STAGED   = join(repoRoot, '_sass/design/_variables-generated.scss');
const OUTPUT_TOKENS   = join(__dirname, 'tokens-extracted.json');
const SCSS_VARIABLES  = join(repoRoot, '_sass/design/_variables.scss');
const SCSS_COLORS     = join(repoRoot, '_sass/design/_colors.scss');
...
async function buildTokensToScss() {
  ...
  console.log('  Review diff: diff _sass/design/_variables.scss _sass/design/_variables-generated.scss');
}

// ============================================================================
// REVERSE: _sass/design/ → tokens-extracted.json
// ============================================================================
