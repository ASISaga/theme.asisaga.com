...
# _sass/design/_variables-generated.scss using Style Dictionary v4.
#
# Usage:
...
GENERATED="$REPO_ROOT/_sass/design/_variables-generated.scss"
PRODUCTION="$REPO_ROOT/_sass/design/_variables.scss"
